...
?>
    <div class="search">
        <form id="uwpqsffrom_107" method="get" action="http://www.empregopraontem.com.br">
            ...
            <input type="hidden" name="uformid" value="107">
            <input type="hidden" name="s" value="uwpsfsearchtrg" />
        </form>
    </div>

    <?php dynamic_sidebar( 'ceara' ); ?>
    ...
    <div class="box-cat">
        ...
        <form action="http://feedburner.google.com/fb/a/mailverify" method="post" target="popupwindow" onsubmit="window.open('http://feedburner.google.com/fb/a/mailverify?uri=ce-epo', 'popupwindow', 'scrollbars=yes,width=300');return true">
            ...
            <input type="hidden" value="ce-epo" name="uri"/>
	...
	<div class="box-cat">
        ...
        <ul>
		  <?php wp_list_categories('taxonomy=categorias-ce&title_li=' . __('') . ''); ?>
        </ul>
    </div>
    ...
    <div class="box-cat">
        ...
        <ul>
        <?php
            $newsArgs = array( 'post_type' => 'ceara', 'posts_per_page' => 10);
    ...
    <div id="face">
        <div class="fb-like-box" data-href="https://www.facebook.com/empregopraontem.ce" data-width="266" data-colorscheme="light" data-show-faces="true" data-header="false" data-stream="false" data-show-border="true"></div>
    </div>