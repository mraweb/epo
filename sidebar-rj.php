...
?>
    <div class="search">
        <form id="uwpqsffrom_47" method="get" action="http://empregopraontem.com.br">
            ...
            <input type="hidden" name="uformid" value="47">
            <input type="hidden" name="s" value="uwpsfsearchtrg" />
        </form>
    </div>
    
    <?php dynamic_sidebar( 'rio-de-janeiro' ); ?>
    ...
    <div class="box-cat">
        ...
        <form action="http://feedburner.google.com/fb/a/mailverify" method="post" target="popupwindow" onsubmit="window.open('http://feedburner.google.com/fb/a/mailverify?uri=rj-epo', 'popupwindow', 'scrollbars=yes,width=300');return true">
            ...
            <input type="hidden" value="rj-epo" name="uri"/>
	...
	<div class="box-cat">
        ...
        <ul>
            <?php wp_list_categories('taxonomy=categorias-rj&title_li=' . __('') . ''); ?>
        </ul>
    </div>
    ...
    <div class="box-cat">
        ...
        <ul>
        <?php
            $newsArgs = array( 'post_type' => 'rio-de-janeiro', 'posts_per_page' => 10);
    ...
    <div id="face">
        <div class="fb-like-box" data-href="https://www.facebook.com/empregopraontem.rj" data-width="266" data-colorscheme="light" data-show-faces="true" data-header="false" data-stream="false" data-show-border="true"></div>
    </div>